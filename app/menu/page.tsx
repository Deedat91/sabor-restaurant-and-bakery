...
const restaurantMenu: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { es: 'Picada Para Dos',              en: 'Sausage, Pork Rinds, Blood Sausage, Salami, Corn Cake, Salted Potatoes & Green Plantains', price: '$16.00' },
      { es: 'Picada Para Cuatro',           en: 'Sausage, Pork Rinds, Blood Sausage, Salami, Corn Cake, Salted Potatoes & Green Plantains', price: '$30.00' },
    ],
  },
  {
    ...
    items: [
      { es: 'Arroz Con Pollo',                 en: 'Chicken with Rice & Beans',        price: '$15.00' },
  ...
  },
  {
    ...
    items: [
      ...
      { es: 'Salmón Al Ajillo',                                   en: 'Salmon in Garlic Sauce',                     price: '$25.00' },
  ...
  },
  {
    ...
    items: [
      ...
      { es: 'Ensalada De César',               en: 'Caesar Salad',                price: '$15.00' },
      { es: 'Ensalada De César Con Pollo',    en: 'Caesar Salad with Chicken',   price: '$13.00' },
  ...
  },
  {
    ...
    items: [
      { es: 'Combo #1 — 1 Pollo a la Brasa, Arroz Grande, Frijoles Pequeños',                                                                                          en: 'Combo #1 — 1 Rotisserie Chicken, Large Rice, Small Beans',                                                                                     price: '$27.00' },
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://www.instagram.com/saborrestaurantandbakery/" target="_blank" className="w-12 h-12 bg-gradient-to-br from-amber-500 to-orange-600 rounded-full flex items-center justify-center hover:scale-110 transition-all"><Instagram size={20} /></a>
                <a href="https://www.facebook.com/people/Sabor-Restaurant-Bakery/61590041587769/" target="_blank" className="w-12 h-12 bg-gradient-to-br from-amber-500 to-orange-600 rounded-full flex items-center justify-center hover:scale-110 transition-all"><Facebook size={20} /></a>
