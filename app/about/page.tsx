        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="flex gap-6 justify-center mt-12">
              ...
              <a href="https://www.facebook.com/people/Sabor-Restaurant-Bakery/61590041587769/" target="_blank" className="text-amber-400 hover:text-amber-300 transition-all hover:scale-110">
                <Facebook size={40} />
              </a>
